    ...
    <div className={cn("bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800", className)}>
      <div className="p-4 border-b border-zinc-200 dark:border-zinc-800">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium text-zinc-900 dark:text-zinc-100">Video Annotations</h3>
          <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-zinc-300 dark:border-zinc-700 rounded-md shadow-sm focus:outline-none focus:ring-amber-500 focus:border-amber-500 dark:bg-zinc-800 dark:text-zinc-100"
                rows={2}
                required
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="textColor" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">
                  Text Color
                </label>
                <input
                  type="color"
                  ...
                  className="w-full h-10 px-3 py-2 border border-zinc-300 dark:border-zinc-700 rounded-md shadow-sm focus:outline-none focus:ring-amber-500 focus:border-amber-500"
                />
              </div>

              <div>
                <label htmlFor="bgColor" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">
                  Background Color
                </label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="fontSize" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">
                  Font Size (px)
                </label>
                <input
                  type="number"
              ...
              <div>
                <label htmlFor="fontWeight" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">
                  Font Weight
                </label>
                <select
                  id="fontWeight"
        ...
        <div className="p-4">
          {annotations.length > 0 ? (
                ...
                <li key={annotation.id} className="py-3">
                  <div className="flex justify-between">
                    <div className="flex-1">
                      <p className="text-sm font-medium text-zinc-900 dark:text-zinc-100">{annotation.text}</p>
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="px-2 py-1 text-xs font-medium text-amber-600 bg-amber-100 rounded hover:bg-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:hover:bg-amber-900/50"
                      >
                        Edit
                      </button>
                      <button
                        onClick={() => handleDelete(annotation.id)}
                        className="px-2 py-1 text-xs font-medium text-red-600 bg-red-100 rounded hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-900/50"
                      >
                        Delete
                      </button>
                    </div>
            ...
            <div className="text-center py-6">
              <p className="text-sm text-zinc-500 dark:text-zinc-400">No annotations for this video yet.</p>
              <p className="text-xs text-zinc-400 dark:text-zinc-500 mt-1">
                Click "Add New" to create your first annotation.
              </p>
            </div>
          )}
        </div>
