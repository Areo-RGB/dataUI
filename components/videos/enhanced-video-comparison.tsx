          ...
          <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
            ...
            <div className="flex flex-wrap items-center gap-x-1 gap-y-1">
              ...
              <button
                ...
                className={cn(
                  "px-1.5 py-0.5 text-xs rounded",
                  playbackSpeed === 0.5 ? "bg-chart-5 text-primary-foreground" : "text-primary-foreground hover:bg-muted/50", // bg-amber-500 text-black -> bg-chart-5 text-primary-foreground, text-white hover:bg-zinc-700 -> text-primary-foreground hover:bg-muted/50
                )}
              ...
              <button
                ...
                className={cn(
                  "px-1.5 py-0.5 text-xs rounded",
                  playbackSpeed === 1 ? "bg-chart-5 text-primary-foreground" : "text-primary-foreground hover:bg-muted/50", // bg-amber-500 text-black -> bg-chart-5 text-primary-foreground, text-white hover:bg-zinc-700 -> text-primary-foreground hover:bg-muted/50
                )}
                aria-label="1x speed"
                title="1x speed"
              >
          ...
          <div className="flex flex-wrap items-center justify-end gap-x-3 gap-y-2">
            ...
            <button
              ...
              className={cn(
                ...
                showAnnotations ? "text-chart-5 hover:text-primary-foreground" : "hover:text-chart-5", // text-amber-400 hover:text-white -> text-chart-5 hover:text-primary-foreground, hover:text-amber-400 -> hover:text-chart-5
              )}
            ...
            <button
              ...
              className={cn(
                "text-primary-foreground transition-colors", // text-white -> text-primary-foreground
                showMetrics ? "text-chart-5 hover:text-primary-foreground" : "hover:text-chart-5", // text-amber-400 hover:text-white -> text-chart-5 hover:text-primary-foreground, hover:text-amber-400 -> hover:text-chart-5
              )}
